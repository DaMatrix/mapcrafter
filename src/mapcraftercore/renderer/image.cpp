...
bool Image<Pixel>::containsRect(size_t x, size_t y, size_t w, size_t h) const noexcept {
...
AUTO_TARGET_CLONES void RGBAImage::alphaBlit(const RGBAImage& image, size_t x, size_t y) {
	assert(containsRect(x, y, image.width, image.height));
